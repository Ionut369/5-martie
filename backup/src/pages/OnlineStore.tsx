            ...
            <div className="relative">
              ...
              <div className="relative bg-primary-900/50 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
                <p className="text-xl text-primary-100 mb-6 text-center">
                  {t('pages.onlineStore.subtitle')}
                </p>
                <p className="text-lg text-primary-100">
                  {t('pages.onlineStore.description')}
                </p>
              </div>
            </div>
          </div>
      ...
      <main className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto space-y-20">
          ...
          <section className="relative">
            ...
            <div className="relative bg-primary-900/50 backdrop-blur-xl rounded-2xl p-12 border border-white/10">
              <h2 className="text-3xl font-bold text-white mb-12 text-center bg-gradient-to-r from-white to-primary-200 text-transparent bg-clip-text">
                {t('pages.onlineStore.problem.title')}
              </h2>
              <p className="text-lg text-primary-100 mb-8 text-center">
                {t('pages.onlineStore.problem.description')}
              </p>
              
              <div className="space-y-8">
                {t('pages.onlineStore.problem.items', { returnObjects: true }).map((item: { title: string; description: string }, index: number) => (
          ...
          <section className="relative">
            ...
            <div className="relative bg-primary-900/50 backdrop-blur-xl rounded-2xl p-12 border border-white/10">
              <h2 className="text-3xl font-bold text-white mb-6 text-center bg-gradient-to-r from-white to-primary-200 text-transparent bg-clip-text">
                {t('pages.onlineStore.solution.title')}
              </h2>
              <p className="text-lg text-primary-100 mb-12 text-center">
                {t('pages.onlineStore.solution.description')}
              </p>

              <div className="grid md:grid-cols-2 gap-8">
                {t('pages.onlineStore.solution.features', { returnObjects: true }).map((feature: { title: string; description: string }, index: number) => (
                  <div key={index} className="bg-primary-800/40 p-8 rounded-xl backdrop-blur-sm">
                    <div className="flex items-start space-x-4">
                      <div className="bg-gradient-to-r from-accent-500 to-primary-500 p-3 rounded-lg">
                        {index === 0 && <ShoppingCart className="w-6 h-6 text-white" />}
          ...
          <section className="relative">
            ...
            <div className="relative bg-primary-900/50 backdrop-blur-xl rounded-2xl p-12 border border-white/10">
              <h2 className="text-3xl font-bold text-white mb-12 text-center bg-gradient-to-r from-white to-primary-200 text-transparent bg-clip-text">
                {t('pages.onlineStore.benefits.title')}
              </h2>
              
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {t('pages.onlineStore.benefits.items', { returnObjects: true }).map((benefit: { title: string; description: string }, index: number) => (
                  <div key={index} className="bg-primary-800/40 p-8 rounded-xl backdrop-blur-sm">
                    <div className="flex items-start space-x-4">
                      <div className="bg-gradient-to-r from-accent-500 to-primary-500 p-3 rounded-lg">
                        ...
                        {index === 3 && <Brain className="w-6 h-6 text-white" />}
            ...
            <div className="relative bg-primary-900/50 backdrop-blur-xl rounded-2xl p-12 border border-white/10">
              <div className="max-w-2xl mx-auto text-center">
                <h2 className="text-3xl font-bold text-white mb-6">
                  {t('pages.onlineStore.cta.title')}
                </h2>
                <p className="text-xl text-primary-100 mb-8">
                  {t('pages.onlineStore.cta.description')}
                </p>
                <button 
                ...
                >
                  {t('pages.onlineStore.cta.button')}
